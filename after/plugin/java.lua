...
local function get_jdtls_workspace_dir()
    return vim.fn.stdpath("data") .. "/jdtls/workspaces/" .. vim.fn.fnamemodify(vim.fs.root(0, {"mvnw", "gradlew"}), ":p:h:t")
...
-- local handlers = require 'vim.lsp.handlers'
-- 
-- local root_files = { 'build.gradle', 'build.gradle.kts' }
-- 
-- local env = {
    --     HOME = vim.loop.os_homedir(),
    --     XDG_CACHE_HOME = os.getenv 'XDG_CACHE_HOME',
    ...
    -- local function get_project_dir()
        ...
        -- 
        -- local function get_jdtls_config_dir()
            --     return vim.fn.stdpath("data") .. "/mason/packages/jdtls/config_win"
            --     -- return "C:/Users/tyfig/.cache/jdtls/config"
            -- end
            -- 
            -- local function get_jdtls_workspace_dir()
                --     return vim.fn.stdpath("data") .. "/jdtls/workspaces/" .. vim.fn.fnamemodify(get_project_dir(), ":p:h:t")
                -- end
                -- 
                -- local function get_jdtls_jvm_args()
                    --     local args = {}
